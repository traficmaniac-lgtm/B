...
## 5. MarketHealth и thin‑edge контроль
...
## 6. GridEngine и построение планов
...
## 7. Источники данных и обработка цены
...
## 8. Stale‑refresh и обновление ордеров
...
## 9. Дедупликация fills и повторов торговых событий
...
## 10. Торговая безопасность и режимы выполнения
...
## 11. Управление ордерами, cancel/reconcile и legacy‑механики
...
## 13. Рекомендуемые точки диагностики
